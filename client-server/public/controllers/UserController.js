...
class UserController{
    ...
    constructor(formIdCreate, formIdUpdate, tableId){
        ...
        this.selectAll(); //carregar localStorage
    }
    ...
    onEdit(){
        ...
        this.formUpdateEl.addEventListener("submit", event => {
            ...
            let result = Object.assign({}, userOld, values); //substituição dos valores diferentes      

            this.getPhoto(this.formUpdateEl).then( 
                (content) => {//se der certo
                    if(!values.photo) {
                    ...
                    user.save().then(user=>{
                        ...
                        this.getTr(user, tr);//substitiu tr pela nova tabela atualizada
